...
void main(void)
{
  ...
  DISP_Str(DISP_COL_CENTER,0,str_startup_screen_line1,0);
  DISP_Str(DISP_COL_CENTER,1,str_startup_screen_line2,0);
  DISP_Str(DISP_COL_CENTER,2,str_startup_screen_line3,0);
