...
{
  DISP_Clr();
  DISP_Str(0x80,0,str_Hardware,0);
  DISP_Str(0x80,1,str_designed,0);
  DISP_Str(0x80,2,str_by,0);
  DISP_Str(0x80,3,str_N7DCC,0);
  BUTTON_Reset();
...
static void MENU_About_Run(void)
{
  ...
  if(BUTTON_count == 1)
  {
    ...
    if(MENU_var.about.step ==0)
    {
      MENU_var.about.step++;
      DISP_Clr();
      DISP_Str(0x80,0,str_YetAnother,0);
      DISP_Str(0x80,1,str_Firmware,0);
      DISP_Str(0x80,2,str_by,0);
      DISP_Str(0x80,3,str_DG4SN,0);
    }
    else
    {
      MENU_Init();
