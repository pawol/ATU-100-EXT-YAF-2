...
void UTILI_SetRelays(void)
{
  ...
  LATBbits.LATB3 = v.bits.B0;
  LATAbits.LATA2 = v.bits.B1;
  LATBbits.LATB4 = v.bits.B2;
  LATAbits.LATA3 = v.bits.B3;
  LATBbits.LATB5 = v.bits.B4;
  LATAbits.LATA5 = v.bits.B5;
  LATAbits.LATA4 = v.bits.B6;

  v.byte = global.cap_relays;
  LATCbits.LATC7 = v.bits.B0;
  LATCbits.LATC3 = v.bits.B1;
  LATCbits.LATC6 = v.bits.B2;
  LATCbits.LATC2 = v.bits.B3;
  LATCbits.LATC5 = v.bits.B4;
  LATCbits.LATC1 = v.bits.B5;
  LATCbits.LATC4 = v.bits.B6;

  LATCbits.LATC0 = global.cap_sw;
...
void UTILI_CalPWR(void)
{
  ...
  int16_t centiVolt = (int16_t) (((int32_t) global.cal_gain * global.adc_f_mV) / 4096) + global.cal_offset;
