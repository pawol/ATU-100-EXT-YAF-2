...
static int16_t f_buffer[10];
static int16_t r_buffer[10];
...
void ADC_Run(void)
{
  ...
  for(i=0; i < (10 -1); i++)
  {
   ...
   f_sum += f_buffer[s] = ADC_GetSample(1);
   r_sum += r_buffer[s] = ADC_GetSample(0);



  global.adc_f_mV = (int16_t)(f_sum / 10);
  global.adc_r_mV = (int16_t)(r_sum / 10);
