...
# 4 "tune.c" 2
# 14 "tune.c"
const uint8_t coarse_cap_value[11] = {
  0b00000000,
  0b00000001,
  0b00000010,
  0b00000100,
...
const uint8_t coarse_ind_value[11] = {
  0b00000000,
  0b00000001,
  0b00000010,
  0b00000100,
...
void TUNE_Run(void)
{
  ...
  switch (TUNE_step)
  {
    ...
    case 10:
      ...
      if ((cap_step >= 11) || (global.SWR > (best_row_swr + (best_row_swr / 20))))
...

      {
        ...
        if ((best_last_row_swr + (best_last_row_swr / 20)) < best_row_swr)
        {
          if (global.cap_sw == 1)
          {
            TUNE_step = 20;
    ...
    case 20:
      ...
      fine_cap_diff_high = (best_cap_step < (11 - 1)) ? (coarse_cap_value[best_cap_step + 1] - coarse_cap_value[best_cap_step]) / 2 : 0;
      fine_ind_diff_low = (best_ind_step > 0) ? (coarse_ind_value[best_ind_step] - coarse_ind_value[best_ind_step - 1]) / 2 : 0;
      fine_ind_diff_high = (best_ind_step < (11 - 1)) ? (coarse_ind_value[best_ind_step + 1] - coarse_ind_value[best_ind_step]) / 2 : 0;
