...
#define DISPLAY_ROTATE      TRUE // Configure display upside down
...
//----------------------------------------------------------------------    
#define TUNEMEM_ITEMS       10  // ilo?c wpisów pamieci strojenia
#define TUNEMEM_STRLEN      8   // ilosc znaków w jednym wpisie
#define SLEEP_WAKEUP_PWR      5 // minimal wakeup power 0.5W
